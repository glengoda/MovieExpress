   ...
   : MEBusinessBase<Account>
  {
    ...
    public Decimal Balance
    {
      ...
      set { SetProperty(BalanceProperty, value); }
        ...
        public static PropertyInfo<string> UserNameProperty = RegisterProperty<string>(c => c.UserName, "Username", "");
        /// <summary>
        ...
        public static PropertyInfo<string> AccountTypeNameProperty = RegisterProperty<string>(c => c.AccountTypeName, "AccountTypeName", "");
        /// <summary>
        /// Gets and sets the Product Description value
        /// </summary>
        [Display(Name = "AccountTypeName", Description = "")]
        public string AccountTypeName
        {
            get { return GetProperty(AccountTypeNameProperty); }
            set { SetProperty(AccountTypeNameProperty, value); }
    ...
    protected void Fetch(SafeDataReader sdr)
    {
      using (BypassPropertyChecks)
      {
        ...
        LoadProperty(AccountTypeNameProperty, sdr.GetString(i++));
