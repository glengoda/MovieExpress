   ...
   : MEBusinessListBase<AccountList, Account>
  {
    ...
    public AccountList()
    {
      // must have parameter-less constructor
        ...
        public static AccountList GetAccountList() // to get all the listy 
        {
            return DataPortal.Fetch<AccountList>(new Criteria());
        }

        public static AccountList GetAccountListById(int? UserID) //method to get a specific ID  (used on Deposit fund to get a currentUserID)
    {
